...
st.header("Example Client Portfolio")
st.subheader("Dashboard for capturing portfolio analytics such as project health, project status, available resources")
...
def render_ring_gauge():
    option = {
        "title": {"text": "Portfolio Health", "left": "center"},
...
def cost():
    option = {
        ...
        "dataset": {
            "source": [
                ["type","20-05-2022",'27-05-2022','03-06-2022','10-06-2022','17-06-2022','24-06-2022','01-07-2022','08-07-2022','15-07-2022','22-07-2022','29-07-2022'],
                ["Forecast Cost",17688,40090,73516,113730,164592,227587,291011,351836,401709,438789,468436],
                ["Incurred Cost",0,24530,32663,51620,0,0,0,0,0,0,0],
                ["Forecast Cost (Minus Port)",0,0,0,0, 51620,140000,202995,266419,327244,377117,414197,443845],
            ]
        },
        "xAxis": {"type": "category","name":"Date","nameLocation":"middle","nameGap":50},
        "yAxis": {"gridIndex": 0,"name":"Cost ($)","nameLocation":"middle","nameGap":50},
        "grid": {"top": "10%"},
        "series": [
            {
                "type": "line",
    ...
    st_echarts(option, height="600px", key="echarts1")
...
st.subheader("Functionality to Present")
markdown = """
1. Project Plan Dashboard Tracking and Monitoring
2. Project Portfolio tracking
3. Monitoring of Project Milestones
4. Task Management
5. Gantt Chart Reporting
6. Resource Tracking and Management
7. Project Calendar and Timelines
8. Project Risks and Issues
"""
