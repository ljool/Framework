...
with col1:   
    ...
    markdown = """
    The Worley Framework for Portfolio Management is a Framework designed to minimise the complexity of managing multiple projects, production assets, offices & labour, and infrastructure scattered across the globe.
  
    The Framework aims to consolidate and standardise the Worley approach to project and portfolio management by reducing the reliance on heritage spreadsheets and systems, and by bringing all project reporting under one umbrella of integrated software.

    The Framework aims to enable Portfolio Managers to make informed decisions on the fly by consolidating all project and portfolio related information into one application and becoming the single source of truth.
    
    This app has been developed for the purpose of detailing and demonstrating the minimal functional and technical requirements of the Worley Portfolio Management Framework.
    
    To use the app, navigate across pages using the sidebar on the left to explore functionality and elements of the framework.
    """
    ...
    3. Enable use of the Framework to all employees - building in levels of confidentiality / access to the platform.
    ...
    markdown = """
    -   It is recommended that a standardized format is established for scheduled reporting for incorporation into the Framework.
    -   Define core requirements / desired fuctionality of the Framework with Portfolio Managers and involved Stakeholders.
    ...
    -   Identify core functionality and introduce the Framework to a test group to see how well it is received.
